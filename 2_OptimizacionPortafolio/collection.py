...
df_splac_AC.to_csv(f'{data_path}/Data/raw_splac.csv', index=True, encoding='utf-8', multi_level_index=False)

##### Alternative, if above doesn't work
    # Go to Google Sheets and PLace the following command
    # =GOOGLEFINANCE("INDEXSP:SPLAC", "all", "2000-01-01", "2026-07-31", "DAILY")
...
end_date = "2026-07-31"
    #Top 40 recorded on 7/31/26
df_raw = yf.download(tickers, start=start_date, end=end_date, auto_adjust=False, multi_level_index=False)
